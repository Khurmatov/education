...
### 1.2 Расчёт необходимого количества нод
...
### 1.3 Выбор оптимальной конфигурации
...
### 2.2 Итоговое количество нод с запасом
...
## 3. Распределение подов по нодам (Affinity/Anti-Affinity)

### 3.1 Стратегия распределения
...
### 3.2 Примерное распределение по 3 нодам
...
## 4. Для нескольких окружений

### 4.1 Вариант 1: Изолированные кластеры
...
### 4.2 Вариант 2: Общий кластер с Resource Quotas
...
## 5. Итоговая спецификация для Helm-чарта

### 5.1 values.yaml (production окружение)
